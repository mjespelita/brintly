		...
		addFile(f, selected) {
				...
				let fileSize = _this.bytesToSize(f.size),
					...
					if (fileType == "jpg" || fileType == "jpeg" || fileType == "png" || fileType == "gif" || fileType == "svg" || fileType == "webp") {
						...
						//icon = '<div class="image" style="background-image: url(./media/' + f.path + ');"></div>';
						icon = '<img class="image" loading="lazy" src="./media/' + f.path + '">';
						isImage = true;
					} else {
				...
				let file = generateElements('<li class="files">\
						...
						<input type="hidden" value="./media/' + f.path + '" name="filename[]">\
